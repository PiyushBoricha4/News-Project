            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php
                            ...
                            $query = "SELECT `post`.`post_id`,`post`.`title`,`post`.`description`,`post`.`post_date`,`category`.`category_name`,`user`.`username`,`post`.`category`,`post`.`author`,`post`.`post_img` FROM `post` 
                        ...
                        <?php
                            ...
                            $query2 = "SELECT * FROM `post` WHERE `post`.`title` LIKE '%{$search_term}%'";
